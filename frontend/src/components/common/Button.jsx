...
export default function Button({ 
  ...
  const variants = {
    ...
    outline: 'border-2 border-slate-300 text-slate-700 hover:border-slate-900 hover:text-slate-900 hover:bg-slate-50 focus:ring-slate-500/50',
    ghost: 'text-slate-600 hover:bg-slate-100 hover:text-slate-900 focus:ring-slate-500/50',
